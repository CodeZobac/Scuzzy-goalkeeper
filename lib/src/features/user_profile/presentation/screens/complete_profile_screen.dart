...
class CompleteProfileScreen extends StatefulWidget {
  ...
  const CompleteProfileScreen({super.key, required this.userProfile});
...
class _CompleteProfileScreenState extends State<CompleteProfileScreen> with TickerProviderStateMixin {
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.userProfile.name.isEmpty || widget.userProfile.gender == null || widget.userProfile.birthDate == null || widget.userProfile.nationality == null)
                              _buildPersonalInfoCard(),
                            const SizedBox(height: AppTheme.spacing),
                            if (widget.userProfile.club == null || (widget.userProfile.isGoalkeeper && widget.userProfile.pricePerGame == null))
  ...
  Widget _buildPersonalInfoCard() {
    return _buildAnimatedCard(
      ...
      [
        if (widget.userProfile.name.isEmpty)
          CustomTextField(
        ...
        if (widget.userProfile.name.isEmpty) const SizedBox(height: AppTheme.spacing),
        if (widget.userProfile.gender == null) _buildGenderDropdown(),
        if (widget.userProfile.gender == null) const SizedBox(height: AppTheme.spacing),
        if (widget.userProfile.birthDate == null) _buildDateField(),
        if (widget.userProfile.birthDate == null) const SizedBox(height: AppTheme.spacing),
  ...
  Widget _buildLocationCard() {
    return _buildAnimatedCard(
      ...
      [
        ...
        if (widget.userProfile.city == null) const SizedBox(height: AppTheme.spacing),
        if (widget.userProfile.country == null)
          CustomTextField(
